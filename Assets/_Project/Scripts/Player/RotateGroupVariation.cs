...
public class RotateGroupVariation : MonoBehaviour
{
    ...
    void Update()
    {
        if (_target != null)
        {
            Vector3 force = GetPositionVariation();
    ...
    private Vector3 GetPositionVariation()
    {
        Vector3 variation = _target.transform.position - _previousTargetPosition;
